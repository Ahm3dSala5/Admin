...
namespace AdminPageTests
{
    public class AdminAssetAttributesAssignAssetAttribuetsTest :IDisposable
    {
        ...
        [Test]
        public void AssignAssetAttributes_WhenClickOnAssignAttribute_MustOpenAssignAttributesPage()
        {
        ...
        [Test]
        public void AssignAssetPage_PageTitleTest()
        {
            // to open assign asset attributes page
            AssignAssetAttributes_WhenClickOnAssignAttribute_MustOpenAssignAttributesPage();

            var title = driver.FindElement(By.XPath("/html/body/div[1]/div/div[2]/div[1]/div/div/h1/span"));
            Assert.AreEqual("Assign Asset Attributes", title.Text);
        ...
        [Test]
        public void AssignAssetAttributesPage_WhenClickOnDashboard_MustReturnToDashbaordPage()
        {
            // to open assign asset attributes page
            AssignAssetAttributes_WhenClickOnAssignAttribute_MustOpenAssignAttributesPage();
        ...
        [Test]
        public void AssignAssetAttributes_AssetSubClassDropdownlist()
        {
            // to open assign asset attributes page
            AssignAssetAttributes_WhenClickOnAssignAttribute_MustOpenAssignAttributesPage();
        ...
        [Test]
        public void AssignAssetAttributes_AssetType()
        {
            // to open assign asset attributes page
            AssignAssetAttributes_WhenClickOnAssignAttribute_MustOpenAssignAttributesPage();
