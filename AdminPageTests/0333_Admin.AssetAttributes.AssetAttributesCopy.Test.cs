...
namespace AdminPageTests
{
    public class AdminAssetAttributesAssetAttribuetCopyTest : IDisposable
    {
        ...
        [Test]
        public void AssetAttributesCopyPage_WhenClickOnAssignAttribute_MustOpenAssetAttributesCopyPage()
        {
        ...
        [Test]
        public void AssetAttributesCopyPage_PageTitleTest()
        {
            // to open asset attributes Copy page
            AssetAttributesCopyPage_WhenClickOnAssignAttribute_MustOpenAssetAttributesCopyPage();

            var title = driver.FindElement(By.XPath("/html/body/div[1]/div/div[2]/div[1]/div/div/h1/span"));
            Assert.AreEqual("Asset Attribute Copy", title.Text);
